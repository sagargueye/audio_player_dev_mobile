...
import fr.cpe.gr6.audioplayer.databinding.ActivityMainLastfmAlbumBinding;
import fr.cpe.gr6.audioplayer.databinding.ActivityMainLastfmBinding;

public class MainActivity_lastfm_album extends AppCompatActivity {
    private ActivityMainLastfmAlbumBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showStartup();
        binding = DataBindingUtil.setContentView(this, R.layout.activity_main_lastfm_album);
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions( MainActivity_lastfm_album.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},STORAGE_PERMISSION_CODE);
        }
    }
